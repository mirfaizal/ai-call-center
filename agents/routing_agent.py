...
class PipelineResult(BaseModel):
    ...
    call_record: CallRecord | None = Field(default=None)
    transcription: TranscriptionResult | None = Field(default=None)
    summary: CallSummary | None = Field(default=None)
    quality_scores: QualityScores | None = Field(default=None)
...
class RoutingAgent:
    ...
    def run(self, input_data: Any, call_id: str | None = None) -> PipelineResult:
        """
