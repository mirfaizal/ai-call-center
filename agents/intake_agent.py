...
class IntakeAgent:
    ...
    def process(self, input_data: Any, call_id: Optional[str] = None) -> CallRecord:
        """
    ...
    def _handle_audio(self, file_path: str, call_id: Optional[str]) -> CallRecord:
    ...
    def _handle_transcript_file(self, file_path: str, call_id: Optional[str]) -> CallRecord:
    ...
    def _handle_raw_text(self, text: str, call_id: Optional[str]) -> CallRecord:
    ...
    def _handle_dict(self, data: dict, call_id: Optional[str]) -> CallRecord:
